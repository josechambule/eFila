...
/**
 */
public class IndicadoresMesnsais extends GenericReportGui {
	 ...
	 *            boolean
	 */
	public IndicadoresMesnsais(Shell parent, boolean activate) {
	...
	protected void createShell() {
		...
		buildShell(REPORT_INDICADORES_MENSAIS, bounds);
	...
	protected void createCompHeader() {
		...
		buildCompdHeader(REPORT_INDICADORES_MENSAIS, icoImage);
	}
	...
	protected void cmdViewReportWidgetSelected() {
		...
		if (calendarStart.getCalendar().getTime().after(
			...
			mb.open();
			                 ...
			                 IndicadoresMensaisReport report = new IndicadoresMensaisReport(
