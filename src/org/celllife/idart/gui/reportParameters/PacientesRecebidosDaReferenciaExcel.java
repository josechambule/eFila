...
public class PacientesRecebidosDaReferenciaExcel  implements IRunnableWithProgress {

    public List<PacienteReferidoXLS> pacienteReferidosDeXLSList ;
    ...
    public PacientesRecebidosDaReferenciaExcel(Shell parent, String reportFileName, Date theStartDate,
                                   Date theEndDate) {
        this.parent = parent;
    ...
    public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
        try {
            ...
            pacienteReferidosDeXLSList = con.getPatientsReferedFrom(sdf.format(theStartDate),sdf.format(theEndDate));

            if (pacienteReferidosDeXLSList.size() > 0) {

                monitor.beginTask("Gerando a Lista ... ", pacienteReferidosDeXLSList.size());
                ...
                HSSFCell reportYearCell = reportYear.createCell(5);
                ...
                int rowNum = 14;
                int i = 0;
                for (PacienteReferidoXLS xls : pacienteReferidosDeXLSList) {
                    i++;
    ...
    public List<PacienteReferidoXLS> getList() {
        return this.pacienteReferidosDeXLSList;
    }
