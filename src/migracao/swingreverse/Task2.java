                ...
                try {
                    ...
                    for (org.celllife.idart.database.hibernate.PatientIdentifier patientIdentifier : patientIdentifiersIdart) {
                        ...
                        try {
                            ...
                            List<migracao.entidades.PatientIdentifier> patientIdentifierOpenmrsFase1 = identifierServiceOpenmrs.findByNidAndNameAndSurname(nidIdart, name, surname);
                            ...
                            if (!patientIdentifierOpenmrsFase1.isEmpty()) {
                                ...
                                List<migracao.entidades.PatientIdentifier> patientIdentifierOpenmrsFase2 = identifierServiceOpenmrs.findAllByNidLikeAndNameLikeAndSurnameLike(nidIdart, name, surname);
                                ...
                                if (!patientIdentifierOpenmrsFase2.isEmpty()) {
                                    ...
                                    List<migracao.entidades.PatientIdentifier> patientIdentifierOpenmrs = identifierServiceOpenmrs.findAllByNidLikeAndNameLikeAndSurnameLike(nidIdartNovo, name, surname);
