 ...
 */
public class PatientExportObject extends BaseReportObject implements
		ReportObject, Serializable {

	private static final long serialVersionUID = 2848990186087487681L;

	private static Logger log = Logger.getLogger(PatientExportObject.class);

	public PatientExportObject() {
		super();
	}
