...
public class FichaStockReport extends AbstractJasperReport {
    ...
    public FichaStockReport(Shell parent, StockCenter stockCenter, Date theStartDate, Date theEndDate, int drugsId) {
        super(parent);
