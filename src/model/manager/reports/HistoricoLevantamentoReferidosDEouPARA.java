...
public class HistoricoLevantamentoReferidosDEouPARA extends AbstractJasperReport {
    ...
    public HistoricoLevantamentoReferidosDEouPARA(Shell parent, Date theStartDate,
                                   Date theEndDate) {
        super(parent);
    ...
    protected String getReportFileName() {
        return "HistoricoLevantamentosReferidosDe";
    }
