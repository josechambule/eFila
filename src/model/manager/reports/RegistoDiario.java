...
public class RegistoDiario {
	...
	private String zeroA4;
	
	private String cincoANove;
	
	private String dezACatorze;
	
	private String quinzeMais;
	...
	public String getZeroA4() {
		return zeroA4;
	}

	public void setZeroA4(String zeroA4) {
		this.zeroA4 = zeroA4;
	}

	public String getCincoANove() {
		return cincoANove;
	}

	public void setCincoANove(String cincoANove) {
		this.cincoANove = cincoANove;
	}

	public String getDezACatorze() {
		return dezACatorze;
	}

	public void setDezACatorze(String dezACatorze) {
		this.dezACatorze = dezACatorze;
	}

	public String getQuinzeMais() {
		return quinzeMais;
	}

	public void setQuinzeMais(String quinzeMais) {
		this.quinzeMais = quinzeMais;
	}
