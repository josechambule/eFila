...
public class PacientesRecebidosDaReferenciaReport extends AbstractJasperReport {
    ...
    public PacientesRecebidosDaReferenciaReport(Shell parent, StockCenter stockCenter, Date theStartDate,
                                                Date theEndDate) {
        super(parent);
